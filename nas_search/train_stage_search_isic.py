...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', type=str,
                        default='/extracephonline/medai_data2/rileyliu/datasets/ISIC2018/Task1_search',
                        help='Model to train and evaluation')
    parser.add_argument('--base_size', type=int, default=256, help="resize base size")
    parser.add_argument('--crop_size', type=int, default=256, help="crop  size")
    parser.add_argument('--epochs', type=int, default=110, help="search epochs")
    ...
    parser.add_argument('--train_portion', type=float, default=0.6, help="dataloader numworkers")
    ...
    parser.add_argument('--infer_epoch', type=int, default=2, help=" val freq(epoch) ")
