...
#
alpha0_stage1_double_deep_ep80= Genotype(normal_down=[('down_dil_conv', 1), ('cweight', 0), ('dep_conv', 0), ('max_pool', 1), ('dil_conv', 3), ('dep_conv', 0), ('down_cweight', 1), ('conv', 3)], normal_down_concat=range(2, 6), normal_up=[('up_conv', 1), ('cweight', 0), ('dep_conv', 0), ('dil_conv', 2), ('dil_conv', 3), ('dep_conv', 0), ('up_cweight', 1), ('conv', 3)], normal_up_concat=range(2, 6), normal_normal=[('dep_conv', 1), ('cweight', 0),('conv', 1), ('dep_conv', 0), ('dil_conv', 3), ('dep_conv', 0), ('dep_conv', 1), ('conv', 3)], normal_normal_concat=range(2, 6))
