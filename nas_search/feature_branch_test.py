...
class BuildNasUnetPruneNormal(nn.Module):
    def __init__(self,genotype, input_c=3,c=16,num_classes=1, meta_node_num=4, layers=9,dp=0,
        ...
        super(BuildNasUnetPruneNormal, self).__init__()
        self.dropout_prob=dp
    ...
    def forward(self, input):
        ...
        self.cell_3_1_f = self.cell_3_1_1(None, self.cell_1_1_f)
        ...
        self.cell_4_2_f =  self.cell_4_2_1(None, self.cell_2_2_f)

        self.cell_4_4_f = self.cell_4_4(None, self.cell_3_3_f)

        # layer 5

        self.cell_5_1_f =  self.cell_5_1_1(self.cell_1_1_f, self.cell_3_1_f)

        self.cell_5_3_f = self.cell_5_3_1(None, self.cell_3_3_f) + \
                          self.cell_5_3_2(self.cell_3_3_f, self.cell_4_4_f)

        # layer 6
        self.cell_6_0_f = self.cell_6_0_0(self.cell_2_0_f, self.cell_4_0_f)

        self.cell_6_2_f = self.cell_6_2_1(self.cell_2_2_f, self.cell_4_2_f) + \
                          self.cell_6_2_2(self.cell_4_2_f, self.cell_5_3_f)

        # layer 7

        self.cell_7_1_f =  self.cell_7_1_1(self.cell_3_1_f, self.cell_5_1_f) + \
...
class BuildNasUnetPruneNormalDown(nn.Module):
    def __init__(self,genotype, input_c=3,c=16,num_classes=1, meta_node_num=4, layers=9,dp=0,
                 use_sharing=True,double_down_channel=True,aux=False):
        super(BuildNasUnetPruneNormalDown, self).__init__()
        self.dropout_prob=dp
        self.input_c=input_c
        self.num_class=num_classes
        self.meta_node_num=meta_node_num
...
class BuildNasUnetPruneNormalUp(nn.Module):
    def __init__(self,genotype, input_c=3,c=16,num_classes=1, meta_node_num=4, layers=9,dp=0,
                 use_sharing=True,double_down_channel=True,aux=False):
        super(BuildNasUnetPruneNormalUp, self).__init__()
        self.dropout_prob=dp
        self.input_c=input_c
        self.num_class=num_classes
        self.meta_node_num=meta_node_num
...
if __name__=="__main__":
    ...
    # cell=BuildCell(alpha0_5_stage1_double_deep_ep80,c_prev_prev=-1, c_prev=256, c=32,cell_type='normal_up',dp=0)
    ...
    network=BuildNasUnetPruneNormalDown(alpha0_5_stage1_double_deep_ep80,input_c=3,c=16,num_classes=1, meta_node_num=4, layers=9,dp=0,
    ...
    print('param size = %fMB', calc_parameters_count(network))
