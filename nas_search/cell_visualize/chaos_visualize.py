...
def create_all_imgs(save_path):
  ...
  experments_list=["stage1",
                   ]
  genotypes_list=[
                  ['stage1_nodouble_deep_ep36',
                   'stage1_nodouble_deep_ep63',
                   'stage1_nodouble_deep_ep83',
                   'stage1_nodouble_deep_150awb',
...
if __name__ == '__main__':
  ...
  parser.add_argument("--save_path",type=str,default="./cells_chaos",help="save path of experments imgs")
