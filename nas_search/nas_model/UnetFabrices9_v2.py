...
class UnetLayer9(nn.Module):
    def __init__(self,input_c=3,c=16,num_classes=1, meta_node_num=4, layers=7,dp=0,
        ...
        super(UnetLayer9, self).__init__()
        ...
        # 32-->64
        self.stem1 = ConvOps(self.c_prev_prev,self.c_prev , kernel_size=3,  stride=1, ops_order='weight_norm_act')
    ...
    def forward(self, input):
        ...
        # layer 2
        self.cell_2_0_f = self.cell_2_0_0(self.stem0_f,self.stem1_f, weights_normal,weights_down,weights_up) * network_weight[2][0][1]/(network_weight[2][0][1]+network_weight[2][0][2]) + \
...
if __name__=="__main__":
    ...
    model=UnetLayer9(input_c = 3, c = 16, num_classes = 1, meta_node_num = 4, layers = 9, dp = 0,
                        use_sharing = True, double_down_channel = True, use_softmax_head = False,
