...
class BuildNasUnetPrune(nn.Module):
    ...
    def forward(self, input):
        ...
        self.ouput_4_0 = F.upsample(self.ouput_4_0, size=(h, w), mode='bilinear', align_corners=False)
        self.ouput_6_0 = F.upsample(self.ouput_6_0, size=(h, w), mode='bilinear', align_corners=False)
        self.ouput_8_0 = F.upsample(self.ouput_8_0, size=(h, w), mode='bilinear', align_corners=False)
...
class BuildNasUnetPrune_full7(nn.Module):
    def __init__(self,genotype, input_c=3,c=16,num_classes=1, meta_node_num=4, layers=9,dp=0,
                 use_sharing=True,double_down_channel=True,aux=False):
        super(BuildNasUnetPrune_full7, self).__init__()
        self.dropout_prob=dp
        self.input_c=input_c
        self.num_class=num_classes
        self.meta_node_num=meta_node_num
        ...
        for i in range(1, self.layers):
            ...
            if  i == 2:
                self.cell_2_0_0 = BuildCell(genotype,
                                       -1, self.c_prev_prev, self.cell_channels[0],
                                       cell_type="normal_normal", dp=self.dropout_prob)
                self.cell_2_0_1 = BuildCell(genotype,
                                       self.c_prev_prev, self.c_prev, self.cell_channels[0],
                                       cell_type="normal_up", dp=self.dropout_prob)

                self.cell_2_2 = BuildCell(genotype,
                                     -1, self.c_prev, self.cell_channels[2],
                                     cell_type="normal_down", dp=self.dropout_prob)

            elif i == 3:

                self.cell_3_1_0 = BuildCell(genotype,
                                       self.c_prev, self.layers_channel[0], self.cell_channels[1],
                                       cell_type="normal_down", dp=self.dropout_prob)
                ...
                self.cell_3_1_2 = BuildCell(genotype,
                                       self.c_prev, self.layers_channel[2], self.cell_channels[1],
                                       cell_type="normal_up", dp=self.dropout_prob)
                ...
                self.cell_4_0_0 = BuildCell(genotype,
                                       self.c_prev_prev, self.layers_channel[0], self.cell_channels[0],
                                       cell_type="normal_normal", dp=self.dropout_prob)
                ...
                self.cell_5_1_1 = BuildCell(genotype,
                                       self.c_prev, self.layers_channel[1], self.cell_channels[1],
                                       cell_type="normal_normal", dp=self.dropout_prob)
    ...
    def forward(self, input):
        ...
        # layer 0
        self.stem0_f = self.stem0(input)
        self.cell_1_1_f= self.stem1(self.stem0_f)
        ...
        # layer 2
        self.cell_2_0_f = self.cell_2_0_0(None, self.stem0_f) + \
                          self.cell_2_0_1(self.stem0_f, self.cell_1_1_f)
        ...
        # layer 4
        self.cell_4_0_f = self.cell_4_0_0(self.stem0_f, self.cell_2_0_f)  + \
                          self.cell_4_0_1(self.cell_2_0_f, self.cell_3_1_f)
...
if __name__=="__main__":
    ...
    double=Genotype(normal_down=[('down_dil_conv', 1), ('shuffle_conv', 0), ('shuffle_conv', 0), ('down_cweight', 1), ('shuffle_conv', 3), ('down_conv', 1), ('down_conv', 1), ('conv', 3)],
         normal_down_concat=range(2, 6),
    ...
    # x = torch.FloatTensor(torch.ones(1, 3, 192, 256))

    alpha0_5_stage1_double_deep_ep80 = Genotype(
        normal_down=[('conv', 0), ('down_dil_conv', 1), ('down_dil_conv', 1), ('dil_conv', 2), ('down_dil_conv', 1),
                     ('shuffle_conv', 3), ('shuffle_conv', 2), ('shuffle_conv', 3)], normal_down_concat=range(2, 6),
        normal_up=[('conv', 0), ('up_dil_conv', 1), ('dil_conv', 2), ('shuffle_conv', 0), ('shuffle_conv', 3),
                   ('cweight', 0), ('up_cweight', 1), ('shuffle_conv', 2)], normal_up_concat=range(2, 6),
        normal_normal=[('shuffle_conv', 1), ('conv', 0), ('dil_conv', 2), ('shuffle_conv', 0), ('shuffle_conv', 3),
                       ('cweight', 0), ('shuffle_conv', 1), ('shuffle_conv', 2)], normal_normal_concat=range(2, 6))

    alpha0_5_stage1_nodouble_deep_ep80 = Genotype(
        normal_down=[('down_conv', 1), ('conv', 0), ('down_conv', 1), ('conv', 0), ('dil_conv', 3),
                     ('down_dil_conv', 1), ('down_dil_conv', 1), ('dil_conv', 4)], normal_down_concat=range(2, 6),
        normal_up=[('up_dil_conv', 1), ('conv', 0), ('conv', 0), ('shuffle_conv', 2), ('dil_conv', 3), ('dep_conv', 2),
                   ('dil_conv', 4), ('shuffle_conv', 3)], normal_up_concat=range(2, 6),
        normal_normal=[('identity', 1), ('conv', 0), ('conv', 0), ('shuffle_conv', 2), ('dil_conv', 3),
                       ('shuffle_conv', 1), ('dil_conv', 4), ('shuffle_conv', 3)], normal_normal_concat=range(2, 6))
    alpha0_5_stage1_nodouble_nodeep_ep80 = Genotype(
        normal_down=[('down_dil_conv', 1), ('dil_conv', 0), ('conv', 2), ('down_dil_conv', 1), ('down_dil_conv', 1),
                     ('conv', 2), ('conv', 2), ('dep_conv', 4)], normal_down_concat=range(2, 6),
        normal_up=[('up_cweight', 1), ('dil_conv', 0), ('conv', 2), ('up_dil_conv', 1), ('conv', 2), ('up_dep_conv', 1),
                   ('conv', 2), ('dep_conv', 4)], normal_up_concat=range(2, 6),
        normal_normal=[('conv', 1), ('dil_conv', 0), ('conv', 2), ('dep_conv', 1), ('conv', 2), ('conv', 3),
                       ('conv', 2), ('dep_conv', 4)], normal_normal_concat=range(2, 6))
    alpha0_5_stage1_double_nodeep_ep80 = Genotype(
        normal_down=[('down_dil_conv', 1), ('conv', 0), ('cweight', 0), ('down_dil_conv', 1), ('shuffle_conv', 3),
                     ('down_dil_conv', 1), ('dil_conv', 3), ('down_dep_conv', 1)], normal_down_concat=range(2, 6),
        normal_up=[('up_dep_conv', 1), ('conv', 0), ('cweight', 0), ('up_conv', 1), ('shuffle_conv', 3), ('up_conv', 1),
                   ('dil_conv', 3), ('dep_conv', 4)], normal_up_concat=range(2, 6),
        normal_normal=[('shuffle_conv', 1), ('conv', 0), ('cweight', 0), ('dil_conv', 2), ('shuffle_conv', 3),
                       ('conv', 2), ('dil_conv', 3), ('conv', 1)], normal_normal_concat=range(2, 6))

    network=BuildNasUnetPrune(alpha0_5_stage1_nodouble_deep_ep80,input_c=3,c=48,num_classes=1, meta_node_num=4, layers=9,dp=0,
                 use_sharing=True,double_down_channel=False)
    ...
    # for name, moudle in network.named_modules():
    #     print(name, type(moudle))
    # print(network)
    flop, param = get_model_complexity_info(network, (3, 192, 256), as_strings=True, print_per_layer_stat=False)
